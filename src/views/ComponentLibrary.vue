<template>
  <h1>Styles and Components</h1>

  <h2 class="group-heading">Typography and Colors</h2>
  ...
  <h2 class="group-heading">Components</h2>
...
<style lang="scss">
  .page--component-library {
    ...
    .component__color-sample {
      height: 40px;
      width: 100%;
    }

    .component__color-name,
